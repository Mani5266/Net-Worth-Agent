    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 font-sans p-8">
        <div className="w-full max-w-md text-center">
          ...
          <a
            href="/login"
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-navy-950 text-white text-sm font-semibold rounded-lg hover:bg-navy-900 transition-colors"
          >
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 font-sans p-8">
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center gap-3 mb-8 justify-center">
          ...
          <span className="text-lg font-extrabold text-navy-950 tracking-tight">
            OnEasy
          </span>
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8 text-center">
          ...
          <button
            ...
            className="w-full py-3 bg-navy-950 text-white border-none rounded-lg text-sm font-semibold cursor-pointer
